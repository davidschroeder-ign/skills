...
| Backlog JQL | `project = HBNXT AND status = "Screening" AND issuetype in (Bug, Task) AND labels != "dug-ticket-refined" AND assignee = "david_schroeder@ign.com" ORDER BY created ASC` |
