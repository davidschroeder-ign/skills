...
Use this scale (where 1 point = 1 engineer day):

| Points | Meaning                                                        |
| ------ | -------------------------------------------------------------- |
| 0.5    | Half a day — trivial change, config tweak                      |
| 1      | ~1 day — straightforward feature or fix                        |
| 2      | ~2 days — moderate complexity, touches multiple files/services |
| 3      | ~3 days — significant feature, needs design thought            |
| 5      | ~5 days — large feature, cross-service, may need TDD           |
...
**2 points** (~2 days) given it touches both the sync layer and the API.
Agree?"
